...
class ImageRenderer(Renderer):
    ...
    def __init__(
        ...
        self._render_ray_depth = render_ray_depth
    ...
    def render_color(self, scene: Scene, geometry: Geometry) -> None:
    ...
    def render_ray_depth(self, scene: Scene, geometry: Geometry) -> None:
    ...
    def render(self, scene: Scene, geometry: Geometry) -> None:
        if self._render_ray_depth:
            return self.render_ray_depth(scene=scene, geometry=geometry)
        return self.render_color(scene=scene, geometry=geometry)
