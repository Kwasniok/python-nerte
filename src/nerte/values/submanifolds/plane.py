...
class Plane(Submanifold2DIn3D):
    """
    Representation of a two-dimensional surface embedded in three dimensional
    manifold where coordinates are derived analogously as for a plane in R3.
    """
    ...
    def __init__(  # pylint: disable=R0913
        ...
        Submanifold2DIn3D.__init__(self, domain)
